    ...
    <>
      <section className="w-full min-h-screen  overflow-hidden">
        ...
        <section className=" flex items-center justify-center w-[100%] m-auto lg:flex-row flex-col">
          <div className="w-full flex justify-center flex-col items-start h-screen bg-fixed bg-cover bg-center bg-[url('https://images.pexels.com/photos/1649771/pexels-photo-1649771.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')]">
            <motion.div
